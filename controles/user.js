...
const UserController = require('../controles/user'); //carga el controlador de usuarios
...
function saveUser(req, res){
  ...
  const params = req.body; // todos los datos que llegan por post como params.name, params.surname, etc.
